...
function renderEmergency() {
  ...
  if (isArmed) {
    ...
    page.innerHTML = `
      ...
      <!-- Quick-dial hero buttons -->
      <div style="display:grid; grid-template-columns:1fr 1fr 1fr; gap:10px; margin-bottom:var(--space-lg);">
        <a href="tel:108" class="em-action-btn em-btn-red" id="quick-dial-108"
           onclick="if(navigator.vibrate)navigator.vibrate([100,50,100])" 
           style="display:flex; flex-direction:column; align-items:center; justify-content:center; padding:16px 8px; border-radius:16px; text-decoration:none; color:white; background:linear-gradient(135deg,#ef4444,#b91c1c); box-shadow:0 4px 20px rgba(239,68,68,0.4); min-height:90px;">
          <span style="font-size:28px;">🚑</span>
          <span style="font-weight:800; font-size:20px; letter-spacing:0.05em;">108</span>
          <span style="font-size:10px; opacity:0.85;">Ambulance</span>
        </a>
        <a href="tel:100" class="em-action-btn em-btn-amber" id="quick-dial-100"
           onclick="if(navigator.vibrate)navigator.vibrate([100,50,100])" 
           style="display:flex; flex-direction:column; align-items:center; justify-content:center; padding:16px 8px; border-radius:16px; text-decoration:none; color:white; background:linear-gradient(135deg,#f59e0b,#b45309); box-shadow:0 4px 20px rgba(245,158,11,0.4); min-height:90px;">
          <span style="font-size:28px;">🚔</span>
          <span style="font-weight:800; font-size:20px; letter-spacing:0.05em;">100</span>
          <span style="font-size:10px; opacity:0.85;">Police</span>
        </a>
        <a href="tel:101" class="em-action-btn em-btn-teal" id="quick-dial-101"
           onclick="if(navigator.vibrate)navigator.vibrate([100,50,100])" 
           style="display:flex; flex-direction:column; align-items:center; justify-content:center; padding:16px 8px; border-radius:16px; text-decoration:none; color:white; background:linear-gradient(135deg,#06b6d4,#0e7490); box-shadow:0 4px 20px rgba(6,182,212,0.4); min-height:90px;">
          <span style="font-size:28px;">🚒</span>
          <span style="font-weight:800; font-size:20px; letter-spacing:0.05em;">101</span>
          <span style="font-size:10px; opacity:0.85;">Fire</span>
        </a>
      </div>
